    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-agentic-lms-automation-system",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-differential-privacy-in-deep-learning",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-my-simple-tezfunds",
          title: 'My Simple TezFunds',
          description: "A blockchain-based crowdfunding platform for women-led businesses, built for the TezAsia’22 Hackathon.",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6E%61%76%79%61%73%72%61%6A%32%30%30%33@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/navyasraj02", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/navya-s-raj", "_blank");
        },
      },{
      id: 'light-theme',
